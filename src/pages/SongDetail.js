...
const songs = {
  ...
  31: {
    subtitle: (
      <span>
        <strong>
          அவர் பூவுக்கு வாசனை தந்தவர் - Avara Poovukku Vaasanai Thandhavar
        </strong>
      </span>
    ),
    lyrics: (
      <>
        ...
        <p className="mt-6">
          4. குடும்பம் வெறுத்த போது உறவு தந்தது யாரு
          <br />
          நானே என்ன வெறுத்ததை மறக்க சொன்னது யாரு
          <br />
          தற்கொலைக்கு ஓடினதை தடுத்து வைச்சது யாரு
          <br />
          ஆனாலும் தேடி வந்தார் இயேசு என்னை பாரு (2)
        </p>
        <p className="mt-8 text-center">
  ...
  32: {
    ...
    lyrics: (
      <>
        <p mt-4>
          ஆலயத்தில் அழகான தூண்களாய்
          <br />
          ஆண்டவர் இயேசு என்னை மாற்றுகிறார்
          <br />
          விளக்கு தண்டின் மேலுள்ள விளக்காக
          <br />
          வெள்ளிச்சமான தேவன் என்னை உயர்த்துகிறார்
        </p>
        <p className="mt-6">
          மாற்றுகிறார் இயேசு மாற்றுகிறார்
          <br />
          உயர்த்துகிறார் என்னை உயர்த்துகிறார்
        </p>
        <p className="mt-6">
          1. ஆடுகளின் பின்னால் போன தாவீதை
          <br />
          இஸ்ரவேலின் அரசனாக மாற்றுகிறார்
          <br />
          ஆராதனை வீரனான சிறுவனையும்
          <br />
          அரியணையில் ஏற்றி அழகு பார்க்கிறார்
          <br />- மாற்றுகிறார்
        </p>
        <p className="mt-6">
          2. சிறை பிடிக்கப்பட்ட அந்த தானியேலை
          <br />
          ஞானிகளின் ஞானியாக மாற்றுகிறார்
          <br />
          மூன்று வேளை ஜெபித்த அந்த தேவ மனிதனை
          <br />
          முதல்வராக தேசத்தில் உயர்த்துகிறார்
          <br />- மாற்றுகிறார்
        </p>
        <p className="mt-6">
          3. அடிமையாக விற்கப்பட்ட யோசேப்பை
          <br />
          சிறைச்சாலை காவலனாக மாற்றுகிறார்
          <br />
          பரிசுத்தத்தை காத்துக் கொண்ட வாலிபனைக்
          <br />
          எகிப்து தேச அதிகாரியாய் உயர்த்துகிறார்
          <br />- மாற்றுகிறார்
        </p>
        <p className="mt-6">
        ...
        <p className="mt-8 text-center">
          <strong style={{ fontSize: "1.875rem" }}>
            Aalayathil Alagaana Thoongalaai Lyrics in English
          </strong>
        </p>
        <p mt-4>
